...
<template>
  <div class="h-screen flex flex-col overflow-hidden bg-neutral-50">
    <!-- 顶部导航栏 -->
    <header class="flex-shrink-0 h-16 bg-white border-b border-neutral-200 z-50">
    ...
    <aside
      v-if="showSidebar"
      :class="[
        'fixed top-16 left-0 bottom-0 h-[calc(100vh-4rem)] bg-white border-r border-neutral-200 z-40 transition-all duration-300',
    ...
    <!-- 主内容区域 -->
    <main :class="mainClasses" class="pt-16 flex-1 min-h-0 flex flex-col">
    ...
    <!-- 页脚 -->
    <footer :class="['flex-shrink-0 border-t border-neutral-200 bg-white py-4 px-6 z-20', showSidebar ? (sidebarCollapsed ? 'lg:ml-16' : 'lg:ml-64') : '']">
