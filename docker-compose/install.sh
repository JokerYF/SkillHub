...
declare -A MESSAGES_ZH_CN=(
    ...
    ["storage_config"]="存储配置"
    ["rustfs_port"]="RustFS API 端口"
    ["rustfs_console"]="RustFS 存储"
...
declare -A MESSAGES_EN=(
    ...
    ["rustfs_port"]="RustFS API port"
    ["rustfs_console"]="RustFS Storage"
    ["rustfs_access_key"]="RustFS Access Key"
    ["rustfs_secret_key"]="RustFS Secret Key"
...
print_ok "RustFS Access Key: $MINIO_ACCESS_KEY"
...
if [ "$NO_INTERACTIVE" = true ]; then
    ...
    read -p "  $(msg "rustfs_port") [9000]: " RUSTFS_PORT
...
echo -e "  $(msg "rustfs_console"): ${BOLD}http://localhost:${RUSTFS_PORT}${NC}"
echo ""
...
echo -e "  $(msg "rustfs_access_key"):  ${MINIO_ACCESS_KEY}"
echo -e "  $(msg "rustfs_secret_key"):  ${MINIO_SECRET_KEY}"
echo ""
